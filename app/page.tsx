...
export default function Home() {
  ...
  const claimRewards = async () => {
    ...
    try {
      ...
      // Call the actual blockchain transaction to claim rewards
      const tx = await anchorClient.claimRewards(rewardBalance);
      ...
      if (tx) {
        ...
        toast.dismiss();
        toast.success(
          `Successfully claimed ${rewardBalance.toFixed(4)} SOL rewards! Transaction: ${tx.slice(0, 8)}...`
        );
